...
Component.prototype.init = function() {
  ...
  if (typeof(this.controller.$afterAttach) === 'function') {
    this.controller.$afterAttach(this.el);
  }
...
Component.prototype.destroy = function(domNode){
  ...
  if (typeof(this.controller.$beforeDetach) === 'function') {
    this.controller.$beforeDetach(domNode);
  }
